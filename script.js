...
let typed = new Typed(".auto-text",{
    strings: [ "UI/UX Designer","Design Engineer", "Product Designer", "Graphic Designer"],
    typeSpeed:70,
    backSpeed:70,
    loop: true
...
const scriptURL = 'https://script.google.com/macros/s/AKfycbwxAG4vgM3dImicxEq8EB4UoW6E481aF8vtMis2OyJRamCRvsyvc3EShOa4tupLWMZrKA/exec'
const form = document.forms['FormSubmitScript']
